#define NGX_CONFIGURE " --prefix=/usr/develop/nginx --with-http_stub_status_module --with-http_ssl_module --with-pcre=/usr/develop/pcre/pcre-8.35"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/usr/develop/nginx/"
#endif
